                ...
                <div className="relative space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {features.map((feature, index) => (
                      <div key={index} className="flex items-start gap-3 p-3 rounded-xl bg-background/50 border border-border">
          ...
          <div className="order-1 lg:order-2">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center gap-3">
                ...
                <span className="text-foreground">Learn on your schedule, at your pace</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0">
                  <div className="w-2 h-2 rounded-full bg-green-500" />
                </div>
                <span className="text-foreground">Practical exercises with real AI tools</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0">
                  <div className="w-2 h-2 rounded-full bg-green-500" />
                </div>
                <span className="text-foreground">Downloadable templates and guides</span>
              </li>
            </ul>
